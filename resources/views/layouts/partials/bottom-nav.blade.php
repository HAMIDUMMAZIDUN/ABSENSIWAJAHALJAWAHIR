<div class="fixed bottom-0 left-0 right-0 h-16 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-40">
    <div class="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-around items-center h-full relative">
            ...
            {{-- Tombol Riwayat --}}
            <a href="{{ route('app.history') }}" class="flex flex-col items-center justify-center w-full text-center {{ request()->routeIs('history') ? 'text-teal-500' : 'text-gray-500 dark:text-gray-400' }} hover:text-teal-500 transition-colors duration-200">
            ...
            {{-- Tombol Profil --}}
            <a href="{{ route('app.profile.edit') }}" class="flex flex-col items-center justify-center w-full text-center {{ request()->routeIs('app.profile.edit') ? 'text-teal-500' : 'text-gray-500 dark:text-gray-400' }} hover:text-teal-500 transition-colors duration-200">
